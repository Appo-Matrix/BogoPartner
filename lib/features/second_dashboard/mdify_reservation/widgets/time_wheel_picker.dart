...
class TimeWheelPicker extends StatefulWidget {
  ...
  const TimeWheelPicker({
    ...
    this.periodWidth = 92,
    this.numberFontSize = PSizes.fontSizeMd,
    this.periodFontSize = PSizes.fontSizeMd,
  });
...
class _TimeWheelPickerState extends State<TimeWheelPicker> {
  ...
  TextStyle get _numberStyle => PAppStyles.poppins(
        color: PAppColors.white,
        fontSize: widget.numberFontSize,
        weight: FontWeight.w600,
      );

  TextStyle get _periodStyle => PAppStyles.poppins(
        color: PAppColors.white,
